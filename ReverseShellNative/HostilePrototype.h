...
RtlCreateProcessParametersEx(
    _Out_ struct RTL_USER_PROCESS_PARAMETERS** pProcessParameters,//PRTL_USER_PROCESS_PARAMETERS* struct RTL_USER_PROCESS_PARAMETERS**
...
NtCreateUserProcess(
    ...
    _In_opt_ struct RTL_USER_PROCESS_PARAMETERS* ProcessParameters, // PRTL_USER_PROCESS_PARAMETERS
    _Inout_ struct PS_CREATE_INFO* CreateInfo,//PPS_CREATE_INFO
    _In_opt_ struct PS_ATTRIBUTE_LIST* AttributeList//PPS_ATTRIBUTE_LIST
